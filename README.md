...
> It additionally contains results of research done into classic finance, digital identity (Sybil-attacks resistance), observation (oracles) and its relation to game theory (there is a betting app testnet mvp for bticoin)
