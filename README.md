...
> 
> It additionally contains MVP-level (minimal viable product) results of research done into classic finance, digital identity (Sybil-attacks resistance), observation (oracles) and its relation to game theory (there is a p2p betting app testnet mvp for bticoin)
