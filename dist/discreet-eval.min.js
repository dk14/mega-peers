...
var Scope = class {
  ...
  declare(e, t, n = void 0, s = false) {
    ...
    if (reservedWords.has(e)) throw new SyntaxError("Unexepected token '" + e + "'");
    if ("var" === t && void 0 === this.functionThis && null !== this.parent) return this.parent.declare(e, t, n, s);
    ...
    return s && (this.globals[e] = true), this[t][e] = true, this.allVars[e] = n, new Prop(this.allVars, e, this.const.hasOwnProperty(e), s);
  }
};
...
addOps(1, (e, t, n, s, r, i, o, a) => {
  if (null === s) throw new TypeError(`Cannot get property ${r} of null`);
  const c = typeof s;
  if ("undefined" === c && void 0 === i) {
    const e2 = a.get(r);
    if (e2.context === o.ctx.sandboxGlobal) {
      o.ctx.options.audit && o.ctx.auditReport?.globalsAccess.add(r);
      const e3 = o.ctx.globalsWhitelist.has(o.ctx.sandboxGlobal[r]) ? o.evals.get(o.ctx.sandboxGlobal[r]) : void 0;
      if (e3) return void t(void 0, e3);
    }
    return e2.context && e2.context[r] === globalThis ? void t(void 0, o.ctx.globalScope.get("this")) : void t(void 0, e2);
  }
  if (void 0 === s) throw new SandboxError("Cannot get property '" + r + "' of undefined");
  if ("object" !== c) "number" === c ? s = new Number(s) : "string" === c ? s = new String(s) : "boolean" === c && (s = new Boolean(s));
  else if (void 0 === s.hasOwnProperty) return void t(void 0, new Prop(void 0, r));
  const p = "function" === c, l = p || !(s.hasOwnProperty(r) || "number" == typeof r);
  if (o.ctx.options.audit && l && "string" == typeof r) {
    let e2 = Object.getPrototypeOf(s);
    do {
      e2.hasOwnProperty(r) && (o.ctx.auditReport && !o.ctx.auditReport.prototypeAccess[e2.constructor.name] && (o.ctx.auditReport.prototypeAccess[e2.constructor.name] = /* @__PURE__ */ new Set()), o.ctx.auditReport?.prototypeAccess[e2.constructor.name].add(r));
    } while (e2 = Object.getPrototypeOf(e2));
  }
  if (l) {
    if (p && !["name", "length", "constructor"].includes(r) && s.hasOwnProperty(r)) {
      const e2 = o.ctx.prototypeWhitelist.get(s.prototype), n2 = o.ctx.options.prototypeReplacements.get(s);
      if (n2) return void t(void 0, new Prop(n2(s, true), r));
      if (!e2 || e2.size && !e2.has(r)) throw new SandboxError(`Static method or property access not permitted: ${s.name}.${r}`);
    }
    if ("constructor" !== r) {
      let e2 = s;
      for (; e2 = Object.getPrototypeOf(e2); ) if (e2.hasOwnProperty(r)) {
        ...
        throw new SandboxError(`Method or property access not permitted: ${e2.constructor.name}.${r}`);
      }
    }
  }
  if (o.evals.has(s[r])) return void t(void 0, o.evals.get(s[r]));
  if (s[r] === globalThis) return void t(void 0, o.ctx.globalScope.get("this"));
  const d = i.isGlobal || p && !sandboxedFunctions.has(s) || o.ctx.globalsWhitelist.has(s);
  t(void 0, new Prop(s, r, false, d));
...
}), addOps(8, (e, t, n, s, r) => t(void 0, r)), addOps(34, (e, t, n, s, r, i, o, a) => {
  t(void 0, a.declare(s, "var", r));
}), addOps(3, (e, t, n, s, r, i, o, a, c) => {
  t(void 0, a.declare(s, "let", r, c && c.isGlobal));
}), addOps(4, (e, t, n, s, r, i, o, a) => {
  t(void 0, a.declare(s, "const", r));
