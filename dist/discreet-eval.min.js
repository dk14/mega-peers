...
var ExecContext = class {
  constructor(e, t, n, s, r, i, o, a, c, p, l, d) {
    this.ctx = e, this.constants = t, this.tree = n, this.getSubscriptions = s, this.setSubscriptions = r, this.changeSubscriptions = i, this.setSubscriptionsGlobal = o, this.changeSubscriptionsGlobal = a, this.evals = c, this.registerSandboxFunction = p, this.allowJit = l, this.evalContext = d;
  }
};
function createContext(e, t) {
  const n = new SandboxGlobal(t.globals), s = { sandbox: e, globalsWhitelist: new Set(Object.values(t.globals)), prototypeWhitelist: new Map([...t.prototypeWhitelist].map((e2) => [e2[0].prototype, e2[1]])), options: t, globalScope: new Scope(null, t.globals, n), sandboxGlobal: n };
  return s.prototypeWhitelist.set(Object.getPrototypeOf([][Symbol.iterator]()), /* @__PURE__ */ new Set()), s;
}
function createExecContext(sandbox, executionTree, evalContext) {
  ...
  if (evalContext) {
    ...
    evals.set(Function, func), evals.set(AsyncFunction, asyncFunc), evals.set(GeneratorFunction, func), evals.set(AsyncGeneratorFunction, asyncFunc), evals.set(eval, evalContext.sandboxedEval(func)), evals.set(setTimeout, evalContext.sandboxedSetTimeout(func)), evals.set(setInterval, evalContext.sandboxedSetInterval(func));
...
var Scope = class {
  constructor(e, t = {}, n) {
    ...
    const s = void 0 !== n || null === e;
    this.parent = e, this.allVars = t, this.let = s ? this.let : keysOnly(t), this.var = s ? keysOnly(t) : this.var, this.globals = null === e ? keysOnly(t) : {}, this.functionThis = n;
  }
  get(e) {
    const t = "this" === e, n = this.getWhereValScope(e, t);
    return n && t ? new Prop({ this: n.functionThis }, e, true, false, true) : n ? new Prop(n.allVars, e, e in n.const, e in n.globals, true) : new Prop(void 0, e);
  }
  set(e, t) {
  ...
  getWhereValScope(e, t = false) {
    return t ? void 0 !== this.functionThis ? this : this.parent?.getWhereValScope(e, t) || null : e in this.allVars ? this : this.parent?.getWhereValScope(e, t) || null;
  }
  getWhereVarScope(e, t = false) {
    return e in this.allVars || null === this.parent || t || void 0 !== this.functionThis ? this : this.parent.getWhereVarScope(e, t);
  }
  declare(e, t, n = void 0, s = false) {
    if ("this" === e) throw new SyntaxError('"this" cannot be declared');
    if (reservedWords.has(e)) throw new SyntaxError("Unexepected token '" + e + "'");
    const r = this.getWhereVarScope(e, "var" !== t);
    if ("var" === t) {
      if (r.var[e]) return r.allVars[e] = n, s ? r.globals[e] = true : delete r.globals[e], new Prop(r.allVars, e, false, r.globals[e], true);
      if (e in r.allVars) throw new SyntaxError(`Identifier '${e}' has already been declared`);
    }
    if (e in r.allVars) throw new SyntaxError(`Identifier '${e}' has already been declared`);
    return s && (r.globals[e] = true), r[t][e] = true, r.allVars[e] = n, new Prop(this.allVars, e, "const" === t, s, true);
  }
};
...
var Prop = class {
  constructor(e, t, n = false, s = false, r = false) {
    this.context = e, this.prop = t, this.isConst = n, this.isGlobal = s, this.isVariable = r;
  }
  get(e) {
...
var ExecReturn = class {
  constructor(e, t, n, s = false, r = false) {
    this.auditReport = e, this.result = t, this.returned = n, this.breakLoop = s, this.continueLoop = r;
  }
};
var optional = {};
function generateArgs(e, t) {
  ...
  return e.forEach((e2, s) => {
    e2.startsWith("...") ? n[e2.substring(3)] = t.slice(s) : n[e2] = t[s];
  }), n;
}
var sandboxedFunctions = /* @__PURE__ */ new WeakSet();
function createFunction(e, t, n, s, r, i) {
  if (s.ctx.options.forbidFunctionCreation) throw new SandboxError("Function creation is forbidden");
  let o;
  return o = void 0 === i ? (...i2) => {
    const o2 = generateArgs(e, i2);
    return executeTree(n, s, t, void 0 === r ? [] : [new Scope(r, o2)]).result;
  } : function(...i2) {
    const o2 = generateArgs(e, i2);
    return executeTree(n, s, t, void 0 === r ? [] : [new Scope(r, o2, this)]).result;
  }, s.registerSandboxFunction(o), sandboxedFunctions.add(o), o;
}
function createFunctionAsync(e, t, n, s, r, i) {
  if (s.ctx.options.forbidFunctionCreation) throw new SandboxError("Function creation is forbidden");
  if (!s.ctx.prototypeWhitelist?.has(Promise.prototype)) throw new SandboxError("Async/await not permitted");
  let o;
  return o = void 0 === i ? async (...i2) => {
    const o2 = generateArgs(e, i2);
    return (await executeTreeAsync(n, s, t, void 0 === r ? [] : [new Scope(r, o2)])).result;
  } : async function(...i2) {
    const o2 = generateArgs(e, i2);
    return (await executeTreeAsync(n, s, t, void 0 === r ? [] : [new Scope(r, o2, this)])).result;
  }, s.registerSandboxFunction(o), sandboxedFunctions.add(o), o;
}
function assignCheck(e, t, n = "assign") {
  ...
  if (e.isGlobal) throw new SandboxError(`Cannot ${n} property '${e.prop.toString()}' of a global object`);
  if (null === e.context) throw new TypeError("Cannot set properties of null");
  if ("function" == typeof e.context[e.prop] && !hasOwnProperty(e.context, e.prop)) throw new SandboxError(`Override prototype property '${e.prop.toString()}' not allowed`);
...
function execMany(e, t, n, s, r, i, o) {
  t === execSync ? _execManySync(e, n, s, r, i, o) : _execManyAsync(e, n, s, r, i, o).catch(s);
}
function _execManySync(e, t, n, s, r, i) {
  const o = [];
  for (let a = 0; a < t.length; a++) {
    let c;
    try {
      c = syncDone((n2) => execSync(e, t[a], s, r, n2, i)).result;
    } catch (e2) {
      return void n(e2);
    }
    if (c instanceof ExecReturn && (c.returned || c.breakLoop || c.continueLoop)) return void n(void 0, c);
    if (isLisp(t[a]) && 8 === t[a][0]) return void n(void 0, new ExecReturn(r.ctx.auditReport, c, true));
    o.push(c);
  }
  n(void 0, o);
}
async function _execManyAsync(e, t, n, s, r, i) {
  const o = [];
  for (let a = 0; a < t.length; a++) {
    let c;
    try {
      let n2;
      c = true === (n2 = asyncDone((n3) => execAsync(e, t[a], s, r, n3, i))).isInstant ? n2.instant : (await n2.p).result;
    } catch (e2) {
      return void n(e2);
    }
    if (c instanceof ExecReturn && (c.returned || c.breakLoop || c.continueLoop)) return void n(void 0, c);
...
function asyncDone(e) {
  let t, n = false;
  const s = new Promise((s2, r) => {
    e((e2, i) => {
      e2 ? r(e2) : (n = true, t = i, s2({ result: i }));
    });
  });
  return { isInstant: n, instant: t, p: s };
}
function syncDone(e) {
  let t, n;
  if (e((e2, s) => {
...
async function execAsync(e, t, n, s, r, i) {
  let o = r;
  ...
  if (!_execNoneRecurse(e, t, n, s, o, true, i) && isLisp(t)) {
    let r2, a2 = t[0];
    try {
      let o2;
      r2 = true === (o2 = asyncDone((r3) => execAsync(e, t[1], n, s, r3, i))).isInstant ? o2.instant : (await o2.p).result;
    } catch (e2) {
      return void o(e2);
    }
    let c, p = r2;
    try {
      p = r2 instanceof Prop ? r2.get(s) : r2;
    } catch (e2) {
      return void o(e2);
    }
    if (20 === a2 || 21 === a2) {
    ...
    if (89 === a2 && null != p) return void o(void 0, p);
    try {
      let r3;
      c = true === (r3 = asyncDone((r4) => execAsync(e, t[2], n, s, r4, i))).isInstant ? r3.instant : (await r3.p).result;
    } catch (e2) {
      return void o(e2);
    }
    let l = c;
    try {
      l = c instanceof Prop ? c.get(s) : c;
    } catch (e2) {
      return void o(e2);
    }
    if (l === optional && (l = void 0), ops.has(a2)) try {
      ops.get(a2)?.(execAsync, o, e, p, l, r2, s, n, c, i);
    } catch (e2) {
      o(e2);
    }
...
function execSync(e, t, n, s, r, i) {
  if (!_execNoneRecurse(e, t, n, s, r, false, i) && isLisp(t)) {
    let o, a = t[0];
    try {
      o = syncDone((r2) => execSync(e, t[1], n, s, r2, i)).result;
    } catch (e2) {
      return void r(e2);
    }
    let c, p = o;
    try {
      p = o instanceof Prop ? o.get(s) : o;
    } catch (e2) {
      return void r(e2);
    }
    if (20 === a || 21 === a) {
      if (null == p) return void r(void 0, optional);
      a = 20 === a ? 1 : 5;
    }
    if (p === optional) {
      if (1 === a || 5 === a) return void r(void 0, p);
      p = void 0;
    }
    if (89 === a && null != p) return void r(void 0, p);
    try {
      c = syncDone((r2) => execSync(e, t[2], n, s, r2, i)).result;
    } catch (e2) {
      return void r(e2);
    }
    let l = c;
    ...
    if (l === optional && (l = void 0), ops.has(a)) try {
      ops.get(a)?.(execSync, r, e, p, l, o, s, n, c, i);
    } catch (e2) {
      r(e2);
    }
    else r(new SyntaxError("Unknown operator: " + a));
  }
}
addOps(1, (e, t, n, s, r, i, o, a) => {
  if (null === s) throw new TypeError(`Cannot read properties of null (reading '${r?.toString()}')`);
  if (!isPropertyKey(r)) try {
    r = `${r}`;
  } catch (p2) {
    return void t(p2);
  }
  if (void 0 === s && void 0 === i && "string" == typeof r) {
    const e2 = a.get(r);
    e2.context === o.ctx.sandboxGlobal && o.ctx.options.audit && o.ctx.auditReport?.globalsAccess.add(r);
    const n2 = e2.context ? e2.context[e2.prop] : void 0;
    if (n2 === globalThis) return void t(void 0, new Prop({ [e2.prop]: o.ctx.sandboxGlobal }, e2.prop, e2.isConst, false, e2.isVariable));
    const s2 = "function" == typeof n2 && o.evals.get(n2);
    return s2 ? void t(void 0, new Prop({ [e2.prop]: s2 }, e2.prop, e2.isConst, true, e2.isVariable)) : void t(void 0, e2);
  }
  if (void 0 === s) throw new SandboxError(`Cannot read properties of undefined (reading '${r.toString()}')`);
  if (!hasPossibleProperties(s)) return void t(void 0, new Prop(void 0, r));
  const c = "function" == typeof s || !hasOwnProperty(s, r);
  if (o.ctx.options.audit && c) {
    let e2 = Object.getPrototypeOf(s);
    do {
      hasOwnProperty(e2, r) && (o.ctx.auditReport && !o.ctx.auditReport.prototypeAccess[e2.constructor.name] && (o.ctx.auditReport.prototypeAccess[e2.constructor.name] = /* @__PURE__ */ new Set()), o.ctx.auditReport?.prototypeAccess[e2.constructor.name].add(r));
    } while (e2 = Object.getPrototypeOf(e2));
  }
  if (c) {
    if ("function" == typeof s && hasOwnProperty(s, r)) {
      const e3 = o.ctx.prototypeWhitelist.get(s.prototype), n2 = o.ctx.options.prototypeReplacements.get(s);
      if (n2) return void t(void 0, new Prop(n2(s, true), r));
      if (!e3 || e3.size && !e3.has(r)) throw new SandboxError(`Static method or property access not permitted: ${s.name}.${r.toString()}`);
    }
    let e2 = s;
    for (; e2 = Object.getPrototypeOf(e2); ) if (hasOwnProperty(e2, r)) {
      const n2 = o.ctx.prototypeWhitelist.get(e2), i2 = o.ctx.options.prototypeReplacements.get(e2.constructor);
      if (i2) return void t(void 0, new Prop(i2(s, false), r));
      if (n2 && (!n2.size || n2.has(r))) break;
      throw new SandboxError(`Method or property access not permitted: ${e2.constructor.name}.${r.toString()}`);
    }
  }
  const p = "function" == typeof s[r] && o.evals.get(s[r]);
  if (p) return void t(void 0, new Prop({ [r]: p }, r, false, true, false));
  if (s[r] === globalThis) return void t(void 0, new Prop({ [r]: o.ctx.sandboxGlobal }, r, false, false, false));
  const l = i.isGlobal || "function" == typeof s && !sandboxedFunctions.has(s) || o.ctx.globalsWhitelist.has(s);
  t(void 0, new Prop(s, r, false, l, false));
}), addOps(5, (e, t, n, s, r, i, o) => {
  if (o.ctx.options.forbidFunctionCalls) throw new SandboxError("Function invocations are not allowed");
  if ("function" != typeof s) throw new TypeError(`${"symbol" == typeof i.prop ? "Symbol" : i.prop} is not a function`);
  const a = r.map((e2) => e2 instanceof SpreadArray ? [...e2.item] : [e2]).flat().map((e2) => valueOrProp(e2, o));
  if ("function" == typeof i) return void t(void 0, i(...a));
  ...
  i.get(o);
  let c = i.context[i.prop](...a);
  "function" == typeof c && (c = o.evals.get(c) || c), c === globalThis && (c = o.ctx.sandboxGlobal), t(void 0, c);
}), addOps(22, (e, t, n, s, r) => {
  let i = {};
  for (const e2 of r) e2.key instanceof SpreadObject ? i = { ...i, ...e2.key.item } : i[e2.key] = e2.val;
  t(void 0, i);
}), addOps(6, (e, t, n, s, r) => t(void 0, new KeyVal(s, r))), addOps(12, (e, t, n, s, r, i, o) => {
  t(void 0, r.map((e2) => e2 instanceof SpreadArray ? [...e2.item] : [e2]).flat().map((e2) => valueOrProp(e2, o)));
}), addOps(23, (e, t, n, s, r) => t(void 0, r)), addOps(35, (e, t, n, s, r) => {
  switch (r) {
    case "true":
  ...
  t(new Error("Unknown symbol: " + r));
}), addOps(7, (e, t, n, s, r) => t(void 0, Number(r.replace(/_/g, "")))), addOps(83, (e, t, n, s, r) => t(void 0, BigInt(r.replace(/_/g, "")))), addOps(2, (e, t, n, s, r, i, o) => t(void 0, o.constants.strings[parseInt(r)])), addOps(85, (e, t, n, s, r, i, o) => {
  const a = o.constants.regexes[parseInt(r)];
  if (!o.ctx.globalsWhitelist.has(RegExp)) throw new SandboxError("Regex not permitted");
  t(void 0, new RegExp(a.regex, a.flags));
}), addOps(84, (e, t, n, s, r, i, o, a) => {
  const c = o.constants.literals[parseInt(r)], [, p, l] = c, d = [];
  let u;
  const f = [];
  ...
  e(n, d, a, o, (e2, n2) => {
    ...
    if (e2) t(e2);
      ...
      t(void 0, p.replace(/(\\\\)*(\\)?\${(\d+)}/g, (e3, t2, n3, r2) => {
        if (n3) return e3;
        return (t2 || "") + `${valueOrProp(s2[r2], o)}`;
      }));
    }
  });
}), addOps(18, (e, t, n, s, r) => {
  t(void 0, new SpreadArray(r));
}), addOps(17, (e, t, n, s, r) => {
  t(void 0, new SpreadObject(r));
}), addOps(24, (e, t, n, s, r) => t(void 0, !r)), addOps(64, (e, t, n, s, r) => t(void 0, ~r)), addOps(25, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, ++i.context[i.prop]);
}), addOps(26, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop]++);
}), addOps(27, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, --i.context[i.prop]);
}), addOps(28, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop]--);
}), addOps(9, (e, t, n, s, r, i, o, a, c) => {
  if (assignCheck(i, o), i.isGlobal = c?.isGlobal || false, i.isVariable) {
    const e2 = a.getWhereValScope(i.prop);
    if (null === e2) throw new ReferenceError(`Cannot assign to undeclared variable '${i.prop}'`);
    i.isGlobal ? e2.globals[i.prop] = true : delete e2.globals[i.prop];
  }
  t(void 0, i.context[i.prop] = r);
}), addOps(66, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] += r);
}), addOps(65, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] -= r);
}), addOps(67, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] /= r);
}), addOps(69, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] *= r);
}), addOps(68, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] **= r);
}), addOps(70, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] %= r);
}), addOps(71, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] ^= r);
}), addOps(72, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] &= r);
}), addOps(73, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] |= r);
}), addOps(76, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] <<= r);
}), addOps(75, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] >>= r);
}), addOps(74, (e, t, n, s, r, i, o) => {
  assignCheck(i, o), t(void 0, i.context[i.prop] >>>= r);
}), addOps(57, (e, t, n, s, r) => t(void 0, s > r)), addOps(56, (e, t, n, s, r) => t(void 0, s < r)), addOps(55, (e, t, n, s, r) => t(void 0, s >= r)), addOps(54, (e, t, n, s, r) => t(void 0, s <= r)), addOps(52, (e, t, n, s, r) => t(void 0, s == r)), addOps(32, (e, t, n, s, r) => t(void 0, s === r)), addOps(53, (e, t, n, s, r) => t(void 0, s != r)), addOps(31, (e, t, n, s, r) => t(void 0, s !== r)), addOps(29, (e, t, n, s, r) => t(void 0, s && r)), addOps(30, (e, t, n, s, r) => t(void 0, s || r)), addOps(89, (e, t, n, s, r) => t(void 0, s ?? r)), addOps(77, (e, t, n, s, r) => t(void 0, s & r)), addOps(78, (e, t, n, s, r) => t(void 0, s | r)), addOps(33, (e, t, n, s, r) => t(void 0, s + r)), addOps(47, (e, t, n, s, r) => t(void 0, s - r)), addOps(59, (e, t, n, s, r) => t(void 0, +r)), addOps(58, (e, t, n, s, r) => t(void 0, -r)), addOps(48, (e, t, n, s, r) => t(void 0, s / r)), addOps(49, (e, t, n, s, r) => t(void 0, s ** r)), addOps(79, (e, t, n, s, r) => t(void 0, s ^ r)), addOps(50, (e, t, n, s, r) => t(void 0, s * r)), addOps(51, (e, t, n, s, r) => t(void 0, s % r)), addOps(80, (e, t, n, s, r) => t(void 0, s << r)), addOps(81, (e, t, n, s, r) => t(void 0, s >> r)), addOps(82, (e, t, n, s, r) => t(void 0, s >>> r)), addOps(60, (e, t, n, s, r, i, o, a) => {
  e(n, r, a, o, (e2, n2) => {
    t(void 0, typeof valueOrProp(n2, o));
  });
}), addOps(62, (e, t, n, s, r) => t(void 0, s instanceof r)), addOps(63, (e, t, n, s, r) => t(void 0, s in r)), addOps(61, (e, t, n, s, r, i, o, a, c) => {
  c instanceof Prop ? (assignCheck(c, o, "delete"), c.isVariable ? t(void 0, false) : t(void 0, delete c.context?.[c.prop])) : t(void 0, true);
}), addOps(8, (e, t, n, s, r) => t(void 0, r)), addOps(34, (e, t, n, s, r, i, o, a, c) => {
  t(void 0, a.declare(s, "var", r, c?.isGlobal || false));
}), addOps(3, (e, t, n, s, r, i, o, a, c) => {
  t(void 0, a.declare(s, "let", r, c?.isGlobal || false));
}), addOps(4, (e, t, n, s, r, i, o, a, c) => {
  t(void 0, a.declare(s, "const", r, c?.isGlobal || false));
}), addOps(11, (e, t, n, s, r, i, o, a) => {
  if (s = [...s], "string" == typeof i[2] || i[2] instanceof CodeString) {
    if (!o.allowJit || !o.evalContext) throw new SandboxError("Unevaluated code detected, JIT not allowed");
    i[2] = r = o.evalContext.lispifyFunction(new CodeString(i[2]), o.constants);
  }
  s.shift() ? t(void 0, createFunctionAsync(s, r, n, o, a)) : t(void 0, createFunction(s, r, n, o, a));
}), addOps(37, (e, t, n, s, r, i, o, a) => {
  if ("string" == typeof i[2] || i[2] instanceof CodeString) {
    if (!o.allowJit || !o.evalContext) throw new SandboxError("Unevaluated code detected, JIT not allowed");
    i[2] = r = o.evalContext.lispifyFunction(new CodeString(i[2]), o.constants);
  }
  const c = s.shift(), p = s.shift();
  let l;
  l = 88 === c ? createFunctionAsync(s, r, n, o, a, p) : createFunction(s, r, n, o, a, p), p && a.declare(p, "var", l), t(void 0, l);
}), addOps(10, (e, t, n, s, r, i, o, a) => {
  if ("string" == typeof i[2] || i[2] instanceof CodeString) {
    if (!o.allowJit || !o.evalContext) throw new SandboxError("Unevaluated code detected, JIT not allowed");
    i[2] = r = o.evalContext.lispifyFunction(new CodeString(i[2]), o.constants);
  }
  const c = s.shift(), p = s.shift();
  let l;
  p && (a = new Scope(a, {})), l = 88 === c ? createFunctionAsync(s, r, n, o, a, p) : createFunction(s, r, n, o, a, p), p && a.declare(p, "let", l), t(void 0, l);
}), addOps(38, (e, t, n, s, r, i, o, a) => {
  const [c, p, l, d, u, f, h] = s;
  let g = true;
  const x = new Scope(a, {}), y = { $$obj: void 0 }, b = new Scope(x, y);
  if (e === execAsync) (async () => {
    let s2;
    for (s2 = asyncDone((t2) => e(n, d, x, o, t2)), y.$$obj = true === (s2 = asyncDone((t2) => e(n, l, x, o, t2))).isInstant ? s2.instant : (await s2.p).result, s2 = asyncDone((t2) => e(n, p, b, o, t2)), c && (g = true === (s2 = asyncDone((t2) => e(n, f, b, o, t2))).isInstant ? s2.instant : (await s2.p).result); g; ) {
      const i2 = {};
      s2 = asyncDone((t2) => e(n, h, new Scope(b, i2), o, t2)), true === s2.isInstant ? s2.instant : (await s2.p).result;
      const a2 = await executeTreeAsync(n, o, r, [new Scope(x, i2)], "loop");
      if (a2 instanceof ExecReturn && a2.returned) return void t(void 0, a2);
      if (a2 instanceof ExecReturn && a2.breakLoop) break;
      s2 = asyncDone((t2) => e(n, u, b, o, t2)), g = true === (s2 = asyncDone((t2) => e(n, f, b, o, t2))).isInstant ? s2.instant : (await s2.p).result;
    }
    t();
  })().catch(t);
  else {
    for (syncDone((t2) => e(n, d, x, o, t2)), y.$$obj = syncDone((t2) => e(n, l, x, o, t2)).result, syncDone((t2) => e(n, p, b, o, t2)), c && (g = syncDone((t2) => e(n, f, b, o, t2)).result); g; ) {
      const s2 = {};
      syncDone((t2) => e(n, h, new Scope(b, s2), o, t2));
      const i2 = executeTree(n, o, r, [new Scope(x, s2)], "loop");
...
}), addOps(86, (e, t, n, s, r, i, o, a, c, p) => {
  if ("switch" === p && "continue" === s || !p) throw new SandboxError("Illegal " + s + " statement");
  t(void 0, new ExecReturn(o.ctx.auditReport, void 0, false, "break" === s, "continue" === s));
}), addOps(13, (e, t, n, s, r, i, o, a, c, p) => {
  e(n, valueOrProp(s, o) ? r.t : r.f, a, o, t, p);
}), addOps(15, (e, t, n, s, r, i, o, a, c, p) => {
  e(n, valueOrProp(s, o) ? r.t : r.f, a, o, t, void 0);
}), addOps(16, (e, t, n, s, r) => t(void 0, new If(s, r))), addOps(14, (e, t, n, s, r) => t(void 0, new If(s, r))), addOps(40, (e, t, n, s, r, i, o, a) => {
  e(n, s, a, o, (s2, i2) => {
    if (s2) t(s2);
    else if (i2 = valueOrProp(i2, o), e === execSync) {
      let s3, c = false;
      for (const p of r) if (c || (c = !p[1] || i2 === valueOrProp(syncDone((t2) => e(n, p[1], a, o, t2)).result, o))) {
        if (!p[2]) continue;
        if (s3 = executeTree(n, o, p[2], [a], "switch"), s3.breakLoop) break;
        if (s3.returned) return void t(void 0, s3);
        if (!p[1]) break;
      }
      t();
    } else (async () => {
      ...
      for (const p of r) {
        let r2;
        if (c || (c = !p[1] || i2 === valueOrProp(true === (r2 = asyncDone((t2) => e(n, p[1], a, o, t2))).isInstant ? r2.instant : (await r2.p).result, o))) {
          if (!p[2]) continue;
          if (s3 = await executeTreeAsync(n, o, p[2], [a], "switch"), s3.breakLoop) break;
          if (s3.returned) return void t(void 0, s3);
          if (!p[1]) break;
        }
      }
...
}), addOps(39, (e, t, n, s, r, i, o, a, c, p) => {
  const [l, d, u] = r;
  executeTreeWithDone(e, (s2, r2) => {
    executeTreeWithDone(e, (i2) => {
      i2 ? t(i2) : s2 ? executeTreeWithDone(e, t, n, o, d, [new Scope(a)], p) : t(void 0, r2);
    }, n, o, u, [new Scope(a, {})]);
  }, n, o, s, [new Scope(a)], p);
}), addOps(87, (e, t) => {
  t();
}), addOps(45, (e, t, n, s, r, i, o) => {
  if (!o.ctx.globalsWhitelist.has(s) && !sandboxedFunctions.has(s)) throw new SandboxError(`Object construction not allowed: ${s.constructor.name}`);
  t(void 0, new s(...r));
}), addOps(46, (e, t, n, s, r) => {
  t(r);
}), addOps(43, (e, t, n, s) => t(void 0, s.pop())), addOps(0, (e, t) => t());
var unexecTypes = /* @__PURE__ */ new Set([11, 37, 10, 38, 39, 40, 14, 16, 60]);
var currentTicks = { current: { ticks: BigInt(0) } };
function _execNoneRecurse(e, t, n, s, r, i, o) {
  const a = i ? execAsync : execSync;
  if (s.ctx.options.executionQuota && s.ctx.options.executionQuota <= e.ticks && ("function" != typeof s.ctx.options.onExecutionQuotaReached || !s.ctx.options.onExecutionQuotaReached(e, n, s, t))) return r(new SandboxError("Execution quota exceeded")), true;
  if (e.ticks++, currentTicks.current = e, t instanceof Prop) try {
    r(void 0, t.get(s));
  } catch (e2) {
    r(e2);
  }
  else if (t === optional) r();
  else if (Array.isArray(t) && !isLisp(t)) 0 === t[0] ? r() : execMany(e, a, t, r, n, s, o);
  else if (isLisp(t)) if (42 === t[0]) execMany(e, a, t[1], r, n, s, o);
  else if (44 === t[0]) i ? s.ctx.prototypeWhitelist?.has(Promise.prototype) ? execAsync(e, t[1], n, s, async (e2, t2) => {
    if (e2) r(e2);
    else try {
      r(void 0, await valueOrProp(t2, s));
    } catch (e3) {
      r(e3);
    }
  }, o).catch(r) : r(new SandboxError("Async/await is not permitted")) : r(new SandboxError("Illegal use of 'await', must be inside async function"));
  else {
    if (!unexecTypes.has(t[0])) return false;
    try {
      ops.get(t[0])?.(a, r, e, t[1], t[2], t, s, n, void 0, o);
    } catch (e2) {
      r(e2);
    }
  }
...
function executeTree(e, t, n, s = [], r) {
  return syncDone((i) => executeTreeWithDone(execSync, i, e, t, n, s, r)).result;
}
async function executeTreeAsync(e, t, n, s = [], r) {
  let i;
  return true === (i = asyncDone((i2) => executeTreeWithDone(execAsync, i2, e, t, n, s, r))).isInstant ? i.instant : (await i.p).result;
}
function executeTreeWithDone(e, t, n, s, r, i = [], o) {
  if (!r) return void t();
  if (!(r instanceof Array)) throw new SyntaxError("Bad execution tree");
  let a, c = s.ctx.globalScope;
  for (; a = i.shift(); ) "object" == typeof a && (c = a instanceof Scope ? a : new Scope(c, a, a instanceof LocalScope ? void 0 : null));
  s.ctx.options.audit && !s.ctx.auditReport && (s.ctx.auditReport = { globalsAccess: /* @__PURE__ */ new Set(), prototypeAccess: {} }), e === execSync ? _executeWithDoneSync(t, n, s, r, c, o) : _executeWithDoneAsync(t, n, s, r, c, o).catch(t);
}
function _executeWithDoneSync(e, t, n, s, r, i) {
...
async function _executeWithDoneAsync(e, t, n, s, r, i) {
  if (!(s instanceof Array)) throw new SyntaxError("Bad execution tree");
  let o = 0;
  for (o = 0; o < s.length; o++) {
    let a, c;
...
function validateAndParseHex(e, t, n) {
  const s = parseHexToInt(e);
  if (Number.isNaN(s) || void 0 !== n && n !== e.length) throw new SyntaxError(t + ": " + e);
  return s;
}
...
function unraw(e) {
  return e.replace(escapeMatch, function(e2, t, n, s, r, i, o, a, c) {
    if (void 0 !== t) return "\\";
    if (void 0 !== n) return parseHexadecimalCode(n);
    if (void 0 !== s) return parseUnicodeCodePointCode(s);
    if (void 0 !== r) return parseUnicodeCode(r, i);
...
function restOfExp(e, t, n, s, r, i, o = {}) {
  ...
  if (quoteCache.set(t.ref, l), s && l.has(t.start - 1)) return t.substring(0, l.get(t.start - 1) - t.start);
  let d, u = false, f = false, h = "", g = false, x = false;
  for (d = 0; d < t.length && !f; d++) {
    let y = t.char(d);
    if ('"' === s || "'" === s || "`" === s) {
      if ("`" !== s || "$" !== y || "{" !== t.char(d + 1) || u) {
        if (y === s && !u) return t.substring(0, d);
      } else {
      ...
      if (y === closings[s]) return t.substring(0, d);
    } else {
      let e2, s2, r2 = t.substring(d).toString();
      if (i) {
        let e3;
        if (e3 = testMultiple(r2, i)) {
          o.regRes = e3, d++, f = true;
          break;
        }
      }
      if (s2 = aNumber.exec(r2)) d += s2[0].length - 1, r2 = t.substring(d).toString();
      else if (h != y) {
        let s3 = null;
        ...
        s3 || (s3 = testMultiple(r2, n)), s3 && (f = true), !f && (e2 = wordReg.exec(r2)) && (g = true, e2[0].length > 1 && (o.words.push(e2[1]), o.lastAnyWord = e2[1], e2[2] && (o.lastWord = e2[2])), e2[0].length > 2 && (d += e2[0].length - 2));
      }
      if (a && (okFirstChars.test(r2) ? f = false : a = false), f) break;
    }
    h = y;
  }
  if (s) throw new SyntaxError("Unclosed '" + s + "'");
...
setLispType(["createArray", "createObject", "group", "arrayProp", "call"], (e, t, n, s, r, i) => {
  let o = emptyString;
  const a = [];
  let c = false, p = s[0].length;
  const l = p;
  ...
  switch (t) {
    ...
    case "createObject":
      u = a.map((t2) => {
        ...
        t2 = t2.trimStart();
        let s2 = "";
        if (f = expectTypes.expFunction.types.function.exec("function " + t2), f) s2 = f[2].trimStart(), n2 = lispify(e, new CodeString("function " + t2.toString().replace(s2, "")));
        else {
          const r2 = restOfExp(e, t2, [/^:/]);
          s2 = lispify(e, r2, [...d, "spreadObject"]), 1 === s2[0] && (s2 = s2[2]), n2 = lispify(e, t2.substring(r2.length + 1));
        }
        return createLisp({ op: 6, a: s2, b: n2 });
      });
  }
  const h = "arrayProp" === t ? s[1] ? 20 : 1 : "call" === t ? s[1] ? 21 : 5 : typesCreate[t];
  i.lispTree = lispify(e, n.substring(p + 1), expectTypes[r].next, createLisp({ op: h, a: i.lispTree, b: u }));
});
var modifierTypes = { inverse: 64, not: 24, positive: 59, negative: 58, typeof: 60, delete: 61 };
setLispType(["inverse", "not", "negative", "positive", "typeof", "delete"], (e, t, n, s, r, i) => {
  const o = restOfExp(e, n.substring(s[0].length), [/^([^\s.?\w$]|\?[^.])/]);
  i.lispTree = lispify(e, n.substring(o.length + s[0].length), restOfExp.next, createLisp({ op: modifierTypes[t], a: i.lispTree, b: lispify(e, o, expectTypes[r].next) }));
});
var incrementTypes = { "++$": 25, "--$": 27, "$++": 26, "$--": 28 };
setLispType(["incrementerBefore"], (e, t, n, s, r, i) => {
  const o = restOfExp(e, n.substring(2), [/^[^\s.\w$]/]);
  i.lispTree = lispify(e, n.substring(o.length + 2), restOfExp.next, createLisp({ op: incrementTypes[s[0] + "$"], a: lispify(e, o, expectTypes[r].next), b: 0 }));
}), setLispType(["incrementerAfter"], (e, t, n, s, r, i) => {
  i.lispTree = lispify(e, n.substring(s[0].length), expectTypes[r].next, createLisp({ op: incrementTypes["$" + s[0]], a: i.lispTree, b: 0 }));
});
var adderTypes = { "&&": 29, "||": 30, "??": 89, instanceof: 62, in: 63, "=": 9, "-=": 65, "+=": 66, "/=": 67, "**=": 68, "*=": 69, "%=": 70, "^=": 71, "&=": 72, "|=": 73, ">>>=": 74, "<<=": 76, ">>=": 75 };
setLispType(["assign", "assignModify", "nullishCoalescing"], (e, t, n, s, r, i) => {
  i.lispTree = createLisp({ op: adderTypes[s[0]], a: i.lispTree, b: lispify(e, n.substring(s[0].length), expectTypes[r].next) });
}), setLispType(["boolOpOr"], (e, t, n, s, r, i) => {
  const o = [expectTypes.inlineIf.types.inlineIf, inlineIfElse, expectTypes.splitter.types.boolOpOr], a = restOfExp(e, n.substring(s[0].length), o);
  i.lispTree = lispify(e, n.substring(a.length + s[0].length), restOfExp.next, createLisp({ op: adderTypes[s[0]], a: i.lispTree, b: lispify(e, a, expectTypes[r].next) }));
}), setLispType(["boolOpAnd"], (e, t, n, s, r, i) => {
  const o = [expectTypes.inlineIf.types.inlineIf, inlineIfElse, expectTypes.splitter.types.boolOpAnd, expectTypes.splitter.types.boolOpOr], a = restOfExp(e, n.substring(s[0].length), o);
  i.lispTree = lispify(e, n.substring(a.length + s[0].length), restOfExp.next, createLisp({ op: adderTypes[s[0]], a: i.lispTree, b: lispify(e, a, expectTypes[r].next) }));
});
var opTypes = { "&": 77, "|": 78, "^": 79, "<<": 80, ">>": 81, ">>>": 82, "<=": 54, ">=": 55, "<": 56, ">": 57, "!==": 31, "!=": 53, "===": 32, "==": 52, "+": 33, "-": 47, "/": 48, "**": 49, "*": 50, "%": 51 };
function extractIfElse(e, t) {
  let n, s, r = 0, i = t.substring(0, 0), o = emptyString, a = true, c = {};
  for (; (i = restOfExp(e, t.substring(i.end - t.start), [elseIf, ifElse, semiColon], void 0, void 0, void 0, c)).length || a; ) {
    ...
    if (p.startsWith("if")) i.end++, r++;
    else if (p.startsWith("else")) n = t.substring(0, i.end - t.start), i.end++, r--, r || i.end--;
    else {
      if (!(s = /^;?\s*else(?![\w$])/.exec(p))) {
        n = o.length ? n : t.substring(0, i.end - t.start);
        break;
      }
      n = t.substring(0, i.end - t.start), i.end += s[0].length - 1, r--, r || (i.end -= s[0].length - 1);
    }
    if (!r) {
...
setLispType(["opHigh", "op", "comparitor", "bitwiseShift", "bitwiseAnd", "bitwiseXor", "bitwiseOr"], (e, t, n, s, r, i) => {
  ...
  switch (t) {
    ...
    case "bitwiseShift":
      o.push(expectTypes.splitter.types.bitwiseShift);
    case "bitwiseAnd":
      o.push(expectTypes.splitter.types.bitwiseAnd);
    case "bitwiseXor":
      o.push(expectTypes.splitter.types.bitwiseXor);
    case "bitwiseOr":
      o.push(expectTypes.splitter.types.bitwiseOr), o.push(expectTypes.splitter.types.boolOpAnd), o.push(expectTypes.splitter.types.boolOpOr);
  }
  const a = restOfExp(e, n.substring(s[0].length), o);
  i.lispTree = lispify(e, n.substring(a.length + s[0].length), restOfExp.next, createLisp({ op: opTypes[s[0]], a: i.lispTree, b: lispify(e, a, expectTypes[r].next) }));
}), setLispType(["inlineIf"], (e, t, n, s, r, i) => {
  let o = false;
  ...
  a.start = n.start + 1, i.lispTree = createLisp({ op: 15, a: i.lispTree, b: createLisp({ op: 16, a: lispifyExpr(e, a), b: lispifyExpr(e, n.substring(s[0].length + a.length + 1)) }) });
}), setLispType(["if"], (e, t, n, s, r, i) => {
  let o = restOfExp(e, n.substring(s[0].length), [], "(");
  const a = extractIfElse(e, n.substring(s[1].length)), c = s[0].length - s[1].length + o.length + 1;
...
}), setLispType(["switch"], (e, t, n, s, r, i) => {
  const o = restOfExp(e, n.substring(s[0].length), [], "(");
  let a = n.toString().indexOf("{", s[0].length + o.length + 1);
  ...
  for (; c = l.exec(p.toString()); ) {
    ...
    let n2 = emptyString, s2 = a = c[0].length + t2.length + 1;
    const r2 = /^\s*\{/.exec(p.substring(s2).toString());
    let i2 = [];
    if (r2) s2 += r2[0].length, n2 = restOfExp(e, p.substring(s2), [], "{"), s2 += n2.length + 1, i2 = lispifyBlock(n2, e);
    else {
      const t3 = restOfExp(e, p.substring(s2), [l]);
      if (t3.trim().length) {
        for (; (n2 = restOfExp(e, p.substring(s2), [semiColon])).length && (s2 += n2.length + (";" === p.char(s2 + n2.length) ? 1 : 0), !l.test(p.substring(s2).toString())); ) ;
        i2 = lispifyBlock(p.substring(a, n2.end - p.start), e);
      } else i2 = [], s2 += t3.length;
    }
    p = p.substring(s2), d.push(createLisp({ op: 41, a: "default" === c[1] ? 0 : lispifyExpr(e, t2), b: i2 }));
  }
  i.lispTree = createLisp({ op: 40, a: lispifyExpr(e, o), b: d });
}), setLispType(["dot", "prop"], (e, t, n, s, r, i) => {
  let o = s[0], a = s[0].length, c = "prop";
  if ("dot" === t) {
    s[1] && (c = "?prop");
    const e2 = n.substring(s[0].length).toString().match(expectTypes.prop.types.prop);
    if (!e2 || !e2.length) throw new SyntaxError("Hanging dot");
    o = e2[0], a = o.length + s[0].length;
  } else if (reservedWords.has(o) && "this" !== o) throw new SyntaxError(`Unexpected token '${o}'`);
  i.lispTree = lispify(e, n.substring(a), expectTypes[r].next, createLisp({ op: typesCreate[c], a: i.lispTree, b: o }));
}), setLispType(["spreadArray", "spreadObject"], (e, t, n, s, r, i) => {
  i.lispTree = createLisp({ op: "spreadArray" === t ? 18 : 17, a: 0, b: lispify(e, n.substring(s[0].length), expectTypes[r].next) });
}), setLispType(["return", "throw"], (e, t, n, s, r, i) => {
  i.lispTree = createLisp({ op: "return" === t ? 8 : 46, a: 0, b: lispifyExpr(e, n.substring(s[0].length)) });
}), setLispType(["number", "boolean", "null", "und", "NaN", "Infinity"], (e, t, n, s, r, i) => {
  i.lispTree = lispify(e, n.substring(s[0].length), expectTypes[r].next, createLisp({ op: "number" === t ? s[12] ? 83 : 7 : 35, a: 0, b: s[12] ? s[1] : s[0] }));
}), setLispType(["string", "literal", "regex"], (e, t, n, s, r, i) => {
  i.lispTree = lispify(e, n.substring(s[0].length), expectTypes[r].next, createLisp({ op: "string" === t ? 2 : "literal" === t ? 84 : 85, a: 0, b: s[1] }));
}), setLispType(["initialize"], (e, t, n, s, r, i) => {
  const o = "var" === s[1] ? 34 : "let" === s[1] ? 3 : 4;
  s[3] ? i.lispTree = createLisp({ op: o, a: s[2], b: lispify(e, n.substring(s[0].length), expectTypes[r].next) }) : i.lispTree = lispify(e, n.substring(s[0].length), expectTypes[r].next, createLisp({ op: o, a: s[2], b: 0 }));
}), setLispType(["function", "inlineFunction", "arrowFunction", "arrowFunctionSingle"], (e, t, n, s, r, i) => {
  const o = "function" !== t && "inlineFunction" !== t, a = o && !s[s.length - 1], c = o ? 2 : 3, p = s[1] ? 88 : 0, l = s[c] ? s[c].replace(/\s+/g, "").split(/,/g) : [];
  o || l.unshift((s[2] || "").trimStart());
  let d = false;
  l.forEach((e2) => {
    if (d) throw new SyntaxError("Rest parameter must be last formal parameter");
    e2.startsWith("...") && (d = true);
  });
  const u = restOfExp(e, n.substring(s[0].length), a ? [/^[,)}\]]/, semiColon] : [/^}/]), f = a ? "return " + u : u.toString();
  l.forEach((e2) => {
    if (reservedWords.has(e2.replace(/^\.\.\./, ""))) throw new SyntaxError(`Unexpected token '${e2}'`);
  }), i.lispTree = lispify(e, n.substring(s[0].length + f.length + 1), expectTypes[r].next, createLisp({ op: o ? 11 : "function" === t ? 37 : 10, a: [p, ...l], b: e.eager ? lispifyFunction(new CodeString(f), e) : f }));
});
var iteratorRegex = /^((let|var|const)\s+)?\s*([a-zA-Z$_][a-zA-Z\d$_]*)\s+(in|of)(?![\w$])/;
setLispType(["for", "do", "while"], (e, t, n, s, r, i) => {
  ...
  switch (t) {
    ...
    case "for": {
      c = n.toString().indexOf("(") + 1;
      const t2 = [];
      let s2, r2 = emptyString;
      for (let s3 = 0; s3 < 3 && (r2 = restOfExp(e, n.substring(c), [/^[;)]/]), t2.push(r2.trim()), c += r2.length + 1, ")" !== n.char(c - 1)); s3++) ;
      if (1 === t2.length && (s2 = iteratorRegex.exec(t2[0].toString()))) "of" === s2[4] ? (d = lispifyReturnExpr(e, t2[0].substring(s2[0].length)), l = [ofStart2, ofStart3], o = ofCondition, h = ofStep, u = lispify(e, new CodeString((s2[1] || "let ") + s2[3] + " = $$next.value"), ["initialize"])) : (d = lispifyReturnExpr(e, t2[0].substring(s2[0].length)), l = [inStart2, inStart3], h = inStep, o = inCondition, u = lispify(e, new CodeString((s2[1] || "let ") + s2[3] + " = $$keys[$$keyIndex]"), ["initialize"]));
      else {
...
setLispType(["try"], (e, t, n, s, r, i) => {
...
}), setLispType(["void", "await"], (e, t, n, s, r, i) => {
  const o = restOfExp(e, n.substring(s[0].length), [/^([^\s.?\w$]|\?[^.])/]);
  i.lispTree = lispify(e, n.substring(s[0].length + o.length), expectTypes[r].next, createLisp({ op: "void" === t ? 87 : 44, a: lispify(e, o), b: 0 }));
}), setLispType(["new"], (e, t, n, s, r, i) => {
  let o = s[0].length;
  ...
  if ("(" === n.char(o - 1)) {
    ...
    o += t2.length + 1;
    let r2 = 0;
    for (; (s2 = restOfExp(e, t2.substring(r2), [/^,/])).length; ) r2 += s2.length + 1, c.push(s2.trim());
  }
...
function lispify(e, t, n, s, r = false) {
  if (s = s || NullLisp, n = n || expectTypes.initialize.next, void 0 === t) return s;
  const i = (t = t.trimStart()).toString();
  if (!t.length && !n.includes("expEnd")) throw new SyntaxError("Unexpected end of expression");
  if (!t.length) return s;
  const o = { lispTree: s };
  let a;
  for (const s2 of n) if ("expEnd" !== s2) {
    for (const n2 in expectTypes[s2].types) if ("expEnd" !== n2 && (a = expectTypes[s2].types[n2].exec(i))) {
      lastType = n2;
      try {
        lispTypes.get(n2)?.(e, n2, t, a, s2, o);
      } catch (e2) {
        if (r && e2 instanceof SyntaxError) throw new ParseError(e2.message, i);
        throw e2;
      }
      break;
    }
  ...
  if (!a && t.length) {
    if (r) throw new ParseError(`Unexpected token after ${lastType}: ${t.char(0)}`, i);
...
function lispifyExpr(e, t, n) {
  ...
  for (n === startingExecpted && (n = startingExpectedWithoutSingle); (r = restOfExp(e, t.substring(i), [/^,/])).length; ) s.push(r.trimStart()), i += r.length + 1;
  if (1 === s.length) return lispify(e, t, n, void 0, true);
  if (n.includes("initialize")) {
    const r2 = expectTypes.initialize.types.initialize.exec(s[0].toString());
    if (r2) return createLisp({ op: 42, a: s.map((t2, n2) => lispify(e, n2 ? new CodeString(r2[1] + " " + t2) : t2, ["initialize"], void 0, true)), b: 0 });
    if (expectTypes.initialize.types.return.exec(s[0].toString())) return lispify(e, t, n, void 0, true);
  }
  const o = s.map((t2) => lispify(e, t2, n, void 0, true));
...
function lispifyBlock(e, t, n = false) {
  ...
  const s = [];
  let r, i = 0, o = 0, a = {}, c = false, p = false;
  for (; (r = restOfExp(t, e.substring(i), [semiColon], void 0, void 0, void 0, a)).length && (p = !(!e.char(i + r.length) || ";" === e.char(i + r.length)), i += r.length + (p ? 0 : 1), /^\s*else(?![\w$])/.test(e.substring(i).toString()) || a.words?.includes("do") && /^\s*while(?![\w$])/.test(e.substring(i).toString()) ? c = true : (c = false, s.push(e.substring(o, i - (p ? 0 : 1))), o = i), a = {}, !n); ) ;
  return c && s.push(e.substring(o, i - (p ? 0 : 1))), s.map((e2) => e2.trimStart()).filter((e2) => e2.length).map((e2) => lispifyExpr(t, e2.trimStart(), startingExecpted));
}
function lispifyFunction(e, t, n = false) {
  if (!e.trim().length) return [];
  const s = lispifyBlock(e, t, n);
  return hoist(s), s;
}
function hoist(e, t = []) {
  if (isLisp(e)) {
    ...
    const [n, s, r] = e;
    if (39 === n || 13 === n || 38 === n || 40 === n) hoist(s, t), hoist(r, t);
    else if (34 === n) t.push(createLisp({ op: 34, a: s, b: 0 }));
    else if (37 === n && s[1]) return t.push(e), true;
  } else if (Array.isArray(e)) {
    const n = [];
    for (const s of e) hoist(s, t) || n.push(s);
...
function insertSemicolons(e, t) {
  let n = t, s = emptyString, r = {};
  const i = insertedSemicolons.get(t.ref) || new Array(t.ref.str.length);
  for (; (s = restOfExp(e, n, [], void 0, void 0, [colonsRegex], r)).length; ) {
    let e2 = false, t2 = s, o = s.length;
    if (r.regRes) {
      e2 = true;
      const [, , i2, , , a] = r.regRes;
      if (o = "++" === r.regRes[3] || "--" === r.regRes[3] ? s.length + 1 : s.length, t2 = n.substring(0, o), a) {
        const t3 = closingsNoInsertion.exec(n.substring(s.length - 1).toString());
        t3 ? e2 = "while" === t3[2] && "do" !== r.lastWord : "function" === r.lastWord && "}" === r.regRes[5][0] && "(" === r.regRes[5].slice(-1) && (e2 = false);
      } else i2 && ("if" !== r.lastWord && "while" !== r.lastWord && "for" !== r.lastWord && "else" !== r.lastWord || (e2 = false));
    }
    e2 && (i[t2.end] = true), n = n.substring(o), r = {};
  }
  return insertedSemicolons.set(t.ref, i), t;
}
function checkRegex(e) {
  let t = 1, n = false, s = false, r = false;
  for (; t < e.length && !s && !r; ) s = "/" === e[t] && !n, n = "\\" === e[t] && !n, r = "\n" === e[t], t++;
  const i = e.substring(t);
  if (r = r || !s || /^\s*\d/.test(i), r) return null;
  const o = /^[a-z]*/.exec(i);
  ...
  for (h = 0; h < t.length; h++) if (l = t[h], a) l === a && ("*" === a && "/" === t[h + 1] ? (a = "", h++) : "\n" === a && (a = ""));
    ...
    if (s) if ("`" === s && "$" === l && "{" === t[h + 1]) {
      ...
      if ("'" === l || '"' === l || "`" === l) p = [], s = l;
        ...
        closings[l] ? (u.push(l), d.push(l)) : closings[u[u.length - 1]] === l ? (u.pop(), d.push(l)) : "/" !== l || "*" !== t[h + 1] && "/" !== t[h + 1] ? "/" === l && !f && (r = checkRegex(t.substring(h))) ? (e.regexes.push(r), d.push("/", e.regexes.length - 1, "/r"), h += r.length - 1) : d.push(l) : (a = "*" === t[h + 1] ? "*" : "\n", c = h);
      }
...
function parse(e, t = false, n = false) {
  ...
  let s = " " + e;
  const r = { strings: [], literals: [], regexes: [], eager: t };
...
function createEvalContext() {
  return { sandboxFunction, sandboxAsyncFunction, sandboxedEval, sandboxedSetTimeout, sandboxedSetInterval, lispifyFunction };
}
function sandboxFunction(e, t) {
  return function SandboxFunction(...n) {
    const s = parse(n.pop() || "");
    return createFunction(n, s.tree, t || currentTicks.current, { ...e, constants: s.constants, tree: s.tree }, void 0, "anonymous");
  };
}
function sandboxAsyncFunction(e, t) {
  return function(...n) {
    const s = parse(n.pop() || "");
    return createFunctionAsync(n, s.tree, t || currentTicks.current, { ...e, constants: s.constants, tree: s.tree }, void 0, "anonymous");
  };
}
...
function subscribeSet(e, t, n, s) {
  if (!(e instanceof Object)) throw new Error("Invalid subscription object, got " + ("object" == typeof e ? "null" : typeof e));
  const r = s.setSubscriptions.get(e) || /* @__PURE__ */ new Map();
  s.setSubscriptions.set(e, r);
  const i = r.get(t) || /* @__PURE__ */ new Set();
  let o;
  r.set(t, i), i.add(n);
  const a = e[t];
  return a instanceof Object && (o = s.changeSubscriptions.get(a) || /* @__PURE__ */ new Set(), o.add(n), s.changeSubscriptions.set(a, o)), { unsubscribe: () => {
...
var SandboxExec = class _SandboxExec {
  ...
  subscribeSet(e, t, n, s) {
    return subscribeSet(e, t, n, s);
  }
...
var Sandbox = class extends SandboxExec {
  ...
  static audit(e, t = []) {
    ...
    const s = new SandboxExec({ globals: n, audit: true });
    return s.executeTree(createExecContext(s, parse(e, true), createEvalContext()), t);
  }
  static parse(e) {
    return parse(e);
  }
